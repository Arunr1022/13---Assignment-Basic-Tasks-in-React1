import Callofduty4 from '../images/separateimages/wp10529290-mw4-wallpapers.png';
...
function Callofduty() {
    ...
    return(
        ...
        <img className='Lastofus' src={Callofduty4} alt="..." />
        </div>

        <div className='Lastofusdiv2'>
        <h2 className='GameHeading'>Call Of Duty - Modern Warfare 4</h2>
